    ...
    onPrepare: function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    return [4 /*yield*/, protractor_1.browser.manage().timeouts().implicitlyWait(5000)];
                case 3:
                    _a.sent();
                    afterEach(function () {
                        return __awaiter(this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, protractor_1.browser.switchTo().defaultContent()];
                                    case 1:
                                        _a.sent();
                                    ...
                                    case 2:
                                        ...
                                        return [4 /*yield*/, protractor_1.browser.manage().timeouts().implicitlyWait(5000)];
                                    case 3:
                                        _a.sent(); // I even rewrite implicit wait back to default value, in case i touched it in tests
                                        return [2 /*return*/];
                                }
                            });
                        });

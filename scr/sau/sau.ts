...
describe('Екран за контакти - това е ТестСуит', () => {
  ...
  it('Test 1 - попълване коректни данни; ', async () => {  
    ...
    await browser.wait(EK.visibilityOf( loginBtn ), timeForWait, 'На екрана се очакваше да има e-mail "' + loginBtn + '", но го няма!');
    await loginBtn.click();
  ...
  it('Test 1 - попълване коректни данни; ', async () => {      
    ...
    await browser.wait(EK.visibilityOf( loginBtn ), timeForWait, 'На екрана се очакваше да има e-mail "' + loginBtn + '", но го няма!'); 
    await loginBtn.click();
    await browser.wait(EK.visibilityOf( lockedUser ), timeForWait, 'На екрана се очакваше да има e-mail "' + lockedUser + '", но го няма!');
